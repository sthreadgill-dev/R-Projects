---
title: "New Mexico Precipitation Choropleth Maps"
...
I chose this specifically because I live in New Mexico, and am trying to stay up to date on our environment.  Rainfall and water are two major concerns for New Mexicans given our desert landscape and climate change. 
...
```
#Generated Map 
![Precipitation Map](precip_map.png)
...
```{r, echo = FALSE}
# Save snapshot PNG for GitHub
mapshot(interactive_nm_map, file = "precip_leaflet.png")

# Save full interactive HTML
htmlwidgets::saveWidget(interactive_nm_map, "precip_leaflet.html", selfcontained = TRUE)
```


### Static snapshot of interactive leaflet map
![Precipitation (leaflet snapshot)](precip_leaflet.png)

### Full interactive map
[Click here to view the interactive precipitation map](precip_leaflet.html)